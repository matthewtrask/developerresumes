    ...
    <div>
        <div class="flex">
            ...
            <div class="flex-1 text-center px-4 py-2 m-2">
                ...
                <a v-if="user.authenticated" class="no-underline pl-4 text-white tracking-wide" href @click.prevent="logout"><i class="fa fa-user" aria-hidden="true"></i>{{ user.profile.data.name }}</a>
